...
public class CursoListar extends javax.swing.JFrame {
    ...
    @Autowired
    StringUtil strUtil;//injeção da classe String util
    ...
    @Autowired
     dao dao;//instanciando para a integração com o BD
    ...
    private void initComponents() {
        ...
        JFrameADDcurso.getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel3.setText("Status");
        JFrameADDcurso.getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, -1, -1));
        ...
        JFrameADDcurso.getContentPane().add(btnConfirmar, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 270, 80, 40));

        cbnovoStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ativo", "Desativado" }));
        JFrameADDcurso.getContentPane().add(cbnovoStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, -1, -1));
        ...
        JFrameADDcurso.getContentPane().add(txtnovosAlunos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 300, 40));
        ...
        btnExcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/ifba/images/image-removebg-preview.png"))); // NOI18N
    ...
    tableModel.addRow(new Object[]{
        ...
        //ponho no db antes da tabela porque só há id deois de um persist
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        //o id só é incrementado apos o persist
        if (strUtil.isNullOrEmpty(txtnomeNovo.getText()) || strUtil.isNullOrEmpty(txtnovosAlunos.getText())) {//verificar se todos os campos foram preenchidos 

            jOptionPane1.showMessageDialog(null, "Não foi possível adicionar o curso");

        }

        Curso capsulaCurso = new Curso(txtnomeNovo.getText(), verificarStatusComboBox(cbnovoStatus), Integer.parseInt(txtnovosAlunos.getText()));//criando um obleto para passar os parametros tanto na lsita qunato na tabela
